...
`docums-print-site-plugin` will fix internal links when combining all the pages into one. Try navigating to other site pages using these internal links:
...
When combining all pages into one, `docums-print-site-plugin` will also ensure anchor links keep working (also to anchor links on other pages). Try them out:
...
From the [docums-charts-plugin](https://khanhduy1407.github.io/docums-charts-plugin/):
...
Docums has support for many markdown extensions (see [docurial reference](https://khanhduy1407.github.io/docurial/reference/admonitions/)). Below is a quick showcase so you can see how they print.
...
`docums-print-site-plugin` supports enumerating figure captions (which can be added easily using the [img2fig](https://github.com/khanhduy1407/docums-img2fig-plugin) plugin):
